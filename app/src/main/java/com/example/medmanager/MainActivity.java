...
//    database object:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor list = DbHelper.getUserList(DbHelper.getWritableDatabase());
        if(list.getCount() == 0){
...
//        });
        expiry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, Expiry.class);
        ...
        FloatingActionButton fab = findViewById(R.id.chatbot);
